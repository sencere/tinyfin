...
- Transformer/BERT-style: small transformer block (embedding + multi-head attention + FFN) with synthetic data; export traces for profiling.
- Text generation: tiny character-level model for quick smoke tests.
